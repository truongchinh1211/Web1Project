...
let totalPages= Math.ceil(productsDB.length/itemsPerPage);
...
changePage(productsDB);
// =================================================== //
// ----------------- renderProduct ------------------- //
// =================================================== //

renderProduct(productsDB,start,end);
...
function renderProduct(productList, s, e) {
    ...
    productList.forEach(function (item, index) {
        if(index>=s && index <e) {
            ...
            product.classList.add("three-col","col"); // modifiy here
            product.innerHTML = ` 
                    <div href="#" class="item-link">
                        <div class="item" data-id="${item.id}">
                            ...
                            <div class="item-option">
                                ...
                                <div class="item-detail-btn item-btn"><i class="fa-solid fa-magnifying-glass"></i></div>
                            </div>
                        </div>
                    </div>
            `;
